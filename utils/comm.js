...
export const loadScript = (url, cb, tag = 'script') => {
...
export const translationsGerman = {
    ...
    'Change element': '更换元素',
    'Expanded pool/participant': '扩展池/参与者',
    ...
    'Create intermediate/boundary event': '创建中间/边界事件',
    'Boundary event': '边界事件',
    'Intermediate throw event': '中间抛送事件',
    'Message intermediate throw event': '消息中间抛送事件',
    ...
    'Assignment type':'指派类型',
    'User assignment':'用户指派',
    'Variable Event':'变量事件',
